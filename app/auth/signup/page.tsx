        ...
        <div className="min-h-screen flex items-center justify-center bg-[#05070d] text-white px-4">
            <div className="w-full max-w-md p-10 rounded-3xl bg-[#0b0f1a]/80 backdrop-blur-xl border border-white/10 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10">
                    <h2 className="text-3xl font-bold mb-2 text-center bg-gradient-to-r from-white to-gray-400 bg-clip-text text-transparent">Create Account</h2>
                    <p className="text-center text-gray-400 mb-8">Join UrbanConnect today</p>
                    ...
                    <p className="mt-8 text-center text-sm text-gray-400">
                        ...
                        <a href="/auth/login" className="ml-1 text-cyan-400 hover:text-cyan-300 font-medium transition-colors">Log in</a>
                    </p>
                </div>
            </div>
        </div>
